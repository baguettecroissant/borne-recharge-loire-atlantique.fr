/**
 * Geographic proximity linking engine for Loire-Atlantique (44).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (47.21°N for Loire-Atlantique)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(47.21°) ≈ 81.0 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 81.0;
